...
public class PdfService {
    private static Document globalDocument;
    ...
    private void addHeaderData() {
        globalDocument.addTitle("My first PDF");
        globalDocument.addSubject("Using iText");
        globalDocument.addKeywords("Java, PDF, iText");
        globalDocument.addAuthor("USER");
        globalDocument.addCreator("USER");
    }
    ...
    private static void addTitlePage()
        ...
        globalDocument.add(preface);
        // Start a new page
        globalDocument.newPage();
    }
